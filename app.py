...
# ===================================================
    ...
    st.subheader("🔮 Predictive Intelligence Panel")
    ...
    # =================================================
    # 2️⃣ PROCESSING TIME SPEEDOMETER
    # =================================================
    with g2:
    ...
    if fail_prob > 0.7:
        ...
        st.success("🟢 LOW RISK — Safe for Auto Processing")
    
    
    # =================================================
    # 4️⃣ FEATURE IMPORTANCE (Explainability)
    # =================================================
